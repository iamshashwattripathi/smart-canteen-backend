    ...
    public ResponseEntity<?> placeOrder(@RequestBody Map<String, Object> body) {
        try {
            ...
            List<Map<String, Object>> cartItems =
                    (List<Map<String, Object>>) body.get("cartItems");
            ...
            return ResponseEntity.ok(Map.of(
                    ...
                    "stallAssigned", order.getStall().getName(),
                    "pickupTime",    order.getPickupTime() != null
                                         ? order.getPickupTime().toString() : "N/A",
