...
public class ReportController {
     ...
     * Returns: totalOrders, totalRevenue, topSellingItem, paidOrders
     * Powers the Admin Dashboard summary cards.
     */
     ...
     * Returns daily revenue for last 7 days — powers the line chart.
     */
     ...
     * Returns top selling items list — powers the item performance section.
     */
