...
public class AISuggestionController {
	...
	/**
	 * GET /api/suggest Returns the recommended food item based on order history.
	 * Powers the AI Food Suggestion page.
	 *
	 * Response: { "recommended": "Veg Burger", "reason": "Most ordered item with 3
	 * orders", "totalOrders": 3, "allTopItems": [...] }
	 */
	@GetMapping
