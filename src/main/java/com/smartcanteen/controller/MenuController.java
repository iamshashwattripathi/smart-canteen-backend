...
public class MenuController {
	...
	/**
	 * GET /api/menu Returns all available menu items grouped by category. Powers
	 * the frontend index.html menu grid.
	 */
	@GetMapping
	...
	/**
	 * GET /api/menu/all Returns flat list (for cart validation).
	 */
	@GetMapping("/all")
	...
	/**
	 * PATCH /api/menu/{id}/toggle [ADMIN] Toggles item availability on/off.
	 */
