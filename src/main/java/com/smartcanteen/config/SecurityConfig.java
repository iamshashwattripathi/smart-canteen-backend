	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.csrf(AbstractHttpConfigurer::disable)
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers("/api/auth/**", "/api/menu/**", "/api/orders/track/**", "/api/tokens/generate",
								"/api/tokens/queue")
						.permitAll()
						...
						.requestMatchers("/api/inventory/**", "/api/reports/**", "/api/orders/queue/**",
								"/api/feedback/all")
						.hasRole("ADMIN")
